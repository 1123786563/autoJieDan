# CLAUDE.md - autoJieDan Project

> Conway Automaton + Nanobot - Sovereign AI Agent Runtime & Personal AI Assistant Framework

## Project Overview

This is a **monorepo** containing multiple AI agent projects:

| Component | Language | Description |
|-----------|----------|-------------|
| **automaton** | TypeScript | Self-improving, self-replicating, sovereign AI agent runtime |
| **nanobot** | Python | Lightweight personal AI assistant framework with multi-platform support |
| **everything-claude-code** | - | Claude Code utilities and skills |
...
│   │   ├── replication/ # Self-replication logic
...
│   ├── nanobot/
│   │   ├── agent/       # Agent core
│   │   ├── channels/    # Platform integrations (Telegram, Slack, etc.)
│   │   ├── providers/   # LLM providers
│   │   └── skills/      # Agent skills
│   └── tests/           # Test files
│
├── everything-claude-code/  # Claude Code utilities
└── docs/                # Documentation
```

## Core Principles

1. **Autonomy First**: Both systems are designed for autonomous operation
2. **Safety by Design**: Constitution-based constraints (automaton), guardrails (nanobot)
3. **Multi-Provider AI**: Support multiple LLM backends
4. **Extensibility**: Skills-based architecture for both systems
...
- Follow constitution constraints (automaton)
