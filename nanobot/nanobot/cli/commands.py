...
@app.command()
def gateway(
    port: int = typer.Option(10790, "--port", "-p", help="Gateway port"),
    verbose: bool = typer.Option(False, "--verbose", "-v", help="Verbose output"),
):
    """Start the nanobot gateway."""
    from nanobot.config.loader import load_config, get_data_dir, validate_required_secrets
    ...
    agent = AgentLoop(
        ...
        browser_config=config.tools.browser if hasattr(config, 'tools') and hasattr(config.tools, 'browser') else None,
    )
